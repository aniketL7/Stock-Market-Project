...
export default class Information extends Component {
  ...
  takeQty(event){
    ...
    async callApi() {
        try {
          console.log("calling api iex!");
            const response = await axios.get('https://cloud.iexapis.com/stable/tops?token='+"86d4cf20a1mshcee5badf5477383p1c85f5jsn614096ee7efd");
